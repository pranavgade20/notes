...
\end{itemize}
	...
	\begin{itemize}
		...
		\item fastest diode
		\item doping $ \propto \dfrac{1}{\sqrt{Doping}} $
		\item switching time is pico seconds
		\item smaller in size, easy to fabricate, negligible internal power consumption
		...
		\item exhibits triple valued property: $ 0 - V_P' , V_P'-V_V', V_V'-V_F $
		\item used in pulsed ckt, oscillators, etc.
	\end{itemize}
